...
import "./FabulousERC20.sol";
import "./libraries/UQ112x112.sol";
import "./libraries/Math.sol";
import "../interfaces/IPancakePair.sol";
import "../interfaces/IPancakeFactory.sol";

contract FabulousPair is IPancakePair, FabulousERC20, ReentrancyGuard {
  ...
  function initialize(address _token0, address _token1) external {
    require(_msgSender() == factory, "FORBIDDEN"); // sufficient check
    token0 = _token0;
    token1 = _token1;
  }
  ...
  function _update(
    ...
    require(balance0 <= uint112(uint256(int256(-1))) && balance1 <= uint112(uint256(int256(-1))), "OVERFLOW");
